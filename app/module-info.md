...
Bienvenido a la documentación oficial de la aplicación móvil para la campaña **"Yo Pongo la Casa con Homecenter"**. Este proyecto está construido bajo los principios de **Clean Architecture** y **Domain Driven Design (DDD)**.
...
## 🌐 Consumo de API https://apitesting.interrapidisimo.co
